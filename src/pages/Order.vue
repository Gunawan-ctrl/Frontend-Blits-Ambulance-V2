    ...
    <div class="col q-col-gutter-md q-ma-md q-mt-lg">
      <q-card>
        ...
        >
          <template v-slot:top>
            <div class="col">
              <div class="col-2 q-table__title">Pesanan Masuk</div>
          ...
          <template v-slot:body="props">
            <q-tr
              ...
              :props="props"
              v-if="props.row.status_pesanan === 0"
            >
...
export default {
  ...
  methods: {
    ...
    exportToCSV() {
      const content = [
        "Kode Pesanan; Nama Pemesan; No Telpon; Titik Jemput; Tujuan; Tanggal Pemesanan; Status Pemesanan;",
      ]
        .concat(
          this.data.map((row) => {
